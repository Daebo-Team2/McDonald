  ...
  <nav>
    <ul class="pagination">
    	<c:if test="${pageStart != 1 }">
       	  <li class="page-item">
       	   <a class="page-link green" onclick="pageMove('/admin/PostContent.do?pageNo=${pageStart - 1}')">
    ...
    <c:if test = "${pageEnd != totalPage }">
          <li class="page-item ">
       		 <a class="page-link green" onclick="pageMove('/admin/postContent.do?pageNo=${pageEnd+1}')">
